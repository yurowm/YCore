...
namespace Yurowm.Utilities {
    ...
    public class EditorStorage : ISerializable {
        ...
        public void Serialize(IWriter writer) {
            writer.WriteDictionary("strings", strings);
            writer.WriteDictionary("bools", bools);
            writer.WriteDictionary("numbers", numbers);
            writer.WriteDictionary("serializables", serializables);
        }
